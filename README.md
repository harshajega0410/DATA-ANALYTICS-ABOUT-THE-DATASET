...
Loading the Dataset – The dataset can be imported using Pandas functions such as read_csv(). Understanding the Dataset – The number of rows, columns, column names, and data types can be identified. Checking Missing Values – Missing or null values are detected using functions such as isnull(). Statistical Analysis – Functions such as describe() provide statistical information about numerical data. Data Cleaning – Duplicate records and missing values can be removed or replaced. Data Visualization – Graphs and charts can be used to understand patterns and relationships in the data. import pandas as pd
# PROCEDURE
...
print(df.head())
# OUTPUT
<img width="786" height="853" alt="image" src="https://github.com/user-attachments/assets/ab3c2b76-c72d-4035-9539-40868b14f46f" />
<img width="507" height="646" alt="image" src="https://github.com/user-attachments/assets/88bc7ff5-996d-48cd-a70f-a5efb4600bf2" />
